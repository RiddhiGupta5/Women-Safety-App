                ...
                try {
                    ...
                    if(place1!=null && place2!=null){
                        ...
                        Routing routing = new Routing.Builder()
                                ...
                                .key("AIzaSyCsKrOG6fSawIcD58dJHw7jL5b-F3l1lgY")
                                .build();
                        routing.execute();
...
//                list.add(new coordinates(1.2, 2.3, 3.3));
//                list.add(new coordinates(3.2, 4.1, 2));
//                pass_id.add("abcd123");
//                pass_id.add("234qwe");

                DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Journey").push();

                //Todo: get value of all distance, latitude and longitude from polyline and add them to journey instance as well
                ref.setValue(new Journey(ref.getKey(), user_id, final_start[0], final_destination[0], date, time));
